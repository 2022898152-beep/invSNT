...
>
    <div @class([
        ...
        <div
            @class([
                'flex items-center space-x-2 text-sm font-medium text-gray-500 rtl:space-x-reverse filament-stats-overview-widget-card-label',
        ...
        <div class="text-3xl font-bold filament-stats-overview-widget-card-value">
            {{ $value }}
        </div>
